...
Rails.application.routes.draw do
  ...
  post 'architecture_selected_discovers' => 'hosts#architecture_selected'
  post 'os_selected_discovers'           => 'hosts#os_selected'
  post 'medium_selected_discovers'       => 'hosts#medium_selected'
